...
var lambda0, phi0$1, lambda1, phi1, // bounds
...
var boundsStream$2 = {
  ...
  polygonEnd: function() {
    ...
    if (areaRingSum < 0) lambda0 = -(lambda1 = 180), phi0$1 = -(phi1 = 90);
    else if (deltaSum > epsilon$2) phi1 = 90;
    else if (deltaSum < -epsilon$2) phi0$1 = -90;
...
function bounds(feature) {
  ...
  return lambda0 === Infinity || phi0$1 === Infinity
      ? [[NaN, NaN], [NaN, NaN]]
      : [[lambda0, phi0$1], [lambda1, phi1]];
}
...
function centroidLinePointFirst(lambda, phi) {
  lambda *= radians$1, phi *= radians$1;
  var cosPhi = cos$1(phi);
  x0$2 = cosPhi * cos$1(lambda);
  y0$2 = cosPhi * sin$1(lambda);
  z0 = sin$1(phi);
  centroidStream.point = centroidLinePoint;
  centroidPointCartesian(x0$2, y0$2, z0);
}
...
function centroidLinePoint(lambda, phi) {
  ...
  var cosPhi = cos$1(phi),
      ...
      z = sin$1(phi),
      w = atan2$1(sqrt$1((w = y0$2 * z - z0 * y) * w + (w = z0 * x - x0$2 * z) * w + (w = x0$2 * y - y0$2 * x) * w), x0$2 * x + y0$2 * y + z0 * z);
  W1 += w;
  X1 += w * (x0$2 + (x0$2 = x));
  Y1 += w * (y0$2 + (y0$2 = y));
  Z1 += w * (z0 + (z0 = z));
    ...
    return {
      ...
      point: function(lambda, phi) {
        ...
        if (v !== v0) {
          ...
          if (!point2 || pointEqual$2(point0, point2) || pointEqual$2(point1, point2))
            point1[2] = 1;
        }
        if (v !== v0) {
          clean = 0;
...
var boundsStream = {
  ...
  polygonEnd: noop$1,
  result: function() {
    var bounds = [[x0$1, y0$1], [x1$1, y1$1]];
...
function sphere(step) {
  var c = [].concat(
    range$1(-180, 180 + step / 2, step).map(sphereTop),
    range$1(180, -180 - step / 2, -step).map(sphereBottom)
  );
  return {
    type: "Polygon",
...
export { airy as geoAiry, airyRaw as geoAiryRaw, aitoff as geoAitoff, aitoffRaw as geoAitoffRaw, armadillo as geoArmadillo, armadilloRaw as geoArmadilloRaw, august as geoAugust, augustRaw as geoAugustRaw, baker as geoBaker, bakerRaw as geoBakerRaw, berghaus as geoBerghaus, berghausRaw as geoBerghausRaw, bertin as geoBertin1953, bertin1953Raw as geoBertin1953Raw, boggs$1 as geoBoggs, boggsRaw as geoBoggsRaw, bonne as geoBonne, bonneRaw as geoBonneRaw, bottomley as geoBottomley, bottomleyRaw as geoBottomleyRaw, bromley as geoBromley, bromleyRaw as geoBromleyRaw, chamberlin as geoChamberlin, chamberlinAfrica as geoChamberlinAfrica, chamberlinRaw as geoChamberlinRaw, collignon$1 as geoCollignon, collignonRaw as geoCollignonRaw, craig as geoCraig, craigRaw as geoCraigRaw, craster as geoCraster, crasterRaw as geoCrasterRaw, cylindricalEqualArea as geoCylindricalEqualArea, cylindricalEqualAreaRaw as geoCylindricalEqualAreaRaw, cylindricalStereographic as geoCylindricalStereographic, cylindricalStereographicRaw as geoCylindricalStereographicRaw, eckert1 as geoEckert1, eckert1Raw as geoEckert1Raw, eckert2 as geoEckert2, eckert2Raw as geoEckert2Raw, eckert3 as geoEckert3, eckert3Raw as geoEckert3Raw, eckert4 as geoEckert4, eckert4Raw as geoEckert4Raw, eckert5 as geoEckert5, eckert5Raw as geoEckert5Raw, eckert6 as geoEckert6, eckert6Raw as geoEckert6Raw, eisenlohr as geoEisenlohr, eisenlohrRaw as geoEisenlohrRaw, fahey as geoFahey, faheyRaw as geoFaheyRaw, foucaut as geoFoucaut, foucautRaw as geoFoucautRaw, foucautSinusoidal as geoFoucautSinusoidal, foucautSinusoidalRaw as geoFoucautSinusoidalRaw, gilbert as geoGilbert, gingery as geoGingery, gingeryRaw as geoGingeryRaw, ginzburg4 as geoGinzburg4, ginzburg4Raw as geoGinzburg4Raw, ginzburg5 as geoGinzburg5, ginzburg5Raw as geoGinzburg5Raw, ginzburg6 as geoGinzburg6, ginzburg6Raw as geoGinzburg6Raw, ginzburg8 as geoGinzburg8, ginzburg8Raw as geoGinzburg8Raw, ginzburg9 as geoGinzburg9, ginzburg9Raw as geoGinzburg9Raw, gringorten$1 as geoGringorten, gringorten as geoGringortenQuincuncial, gringortenRaw as geoGringortenRaw, guyou as geoGuyou, guyouRaw as geoGuyouRaw, hammer as geoHammer, hammerRaw as geoHammerRaw, hammerRetroazimuthal as geoHammerRetroazimuthal, hammerRetroazimuthalRaw as geoHammerRetroazimuthalRaw, healpix as geoHealpix, healpixRaw as geoHealpixRaw, hill as geoHill, hillRaw as geoHillRaw, homolosine$1 as geoHomolosine, homolosineRaw as geoHomolosineRaw, hufnagel as geoHufnagel, hufnagelRaw as geoHufnagelRaw, hyperelliptical as geoHyperelliptical, hyperellipticalRaw as geoHyperellipticalRaw, interrupt as geoInterrupt, boggs as geoInterruptedBoggs, homolosine as geoInterruptedHomolosine, mollweide as geoInterruptedMollweide, mollweideHemispheres as geoInterruptedMollweideHemispheres, quarticAuthalic as geoInterruptedQuarticAuthalic, sinuMollweide as geoInterruptedSinuMollweide, sinusoidal as geoInterruptedSinusoidal, kavrayskiy7 as geoKavrayskiy7, kavrayskiy7Raw as geoKavrayskiy7Raw, lagrange as geoLagrange, lagrangeRaw as geoLagrangeRaw, larrivee as geoLarrivee, larriveeRaw as geoLarriveeRaw, laskowski as geoLaskowski, laskowskiRaw as geoLaskowskiRaw, littrow as geoLittrow, littrowRaw as geoLittrowRaw, loximuthal as geoLoximuthal, loximuthalRaw as geoLoximuthalRaw, miller$1 as geoMiller, millerRaw as geoMillerRaw, modifiedStereographic as geoModifiedStereographic, modifiedStereographicAlaska as geoModifiedStereographicAlaska, modifiedStereographicGs48 as geoModifiedStereographicGs48, modifiedStereographicGs50 as geoModifiedStereographicGs50, modifiedStereographicLee as geoModifiedStereographicLee, modifiedStereographicMiller as geoModifiedStereographicMiller, modifiedStereographicRaw as geoModifiedStereographicRaw, mollweide$1 as geoMollweide, mollweideRaw as geoMollweideRaw, mtFlatPolarParabolic as geoMtFlatPolarParabolic, mtFlatPolarParabolicRaw as geoMtFlatPolarParabolicRaw, mtFlatPolarQuartic as geoMtFlatPolarQuartic, mtFlatPolarQuarticRaw as geoMtFlatPolarQuarticRaw, mtFlatPolarSinusoidal as geoMtFlatPolarSinusoidal, mtFlatPolarSinusoidalRaw as geoMtFlatPolarSinusoidalRaw, naturalEarth2 as geoNaturalEarth2, naturalEarth2Raw as geoNaturalEarth2Raw, nellHammer as geoNellHammer, nellHammerRaw as geoNellHammerRaw, nicolosi as geoNicolosi, nicolosiRaw as geoNicolosiRaw, patterson as geoPatterson, pattersonRaw as geoPattersonRaw, peirce as geoPeirceQuincuncial, polyconic as geoPolyconic, polyconicRaw as geoPolyconicRaw, polyhedral as geoPolyhedral, butterfly as geoPolyhedralButterfly, collignon as geoPolyhedralCollignon, waterman as geoPolyhedralWaterman, index as geoProject, quantize$1 as geoQuantize, quincuncial as geoQuincuncial, rectangularPolyconic as geoRectangularPolyconic, rectangularPolyconicRaw as geoRectangularPolyconicRaw, robinson as geoRobinson, robinsonRaw as geoRobinsonRaw, satellite as geoSatellite, satelliteRaw as geoSatelliteRaw, sinuMollweide$1 as geoSinuMollweide, sinuMollweideRaw as geoSinuMollweideRaw, sinusoidal$1 as geoSinusoidal, sinusoidalRaw as geoSinusoidalRaw, stitch as geoStitch, times as geoTimes, timesRaw as geoTimesRaw, twoPointAzimuthal as geoTwoPointAzimuthal, twoPointAzimuthalRaw as geoTwoPointAzimuthalRaw, twoPointAzimuthalUsa as geoTwoPointAzimuthalUsa, twoPointEquidistant as geoTwoPointEquidistant, twoPointEquidistantRaw as geoTwoPointEquidistantRaw, twoPointEquidistantUsa as geoTwoPointEquidistantUsa, vanDerGrinten as geoVanDerGrinten, vanDerGrinten2 as geoVanDerGrinten2, vanDerGrinten2Raw as geoVanDerGrinten2Raw, vanDerGrinten3 as geoVanDerGrinten3, vanDerGrinten3Raw as geoVanDerGrinten3Raw, vanDerGrinten4 as geoVanDerGrinten4, vanDerGrinten4Raw as geoVanDerGrinten4Raw, vanDerGrintenRaw as geoVanDerGrintenRaw, wagner as geoWagner, wagner4 as geoWagner4, wagner4Raw as geoWagner4Raw, wagner6 as geoWagner6, wagner6Raw as geoWagner6Raw, wagner7 as geoWagner7, wagnerRaw as geoWagnerRaw, wiechel as geoWiechel, wiechelRaw as geoWiechelRaw, winkel3 as geoWinkel3, winkel3Raw as geoWinkel3Raw };
